import '/admin_pages/add_resource/add_resource_widget.dart';
...
class ResourcesListWidget extends StatefulWidget {
  const ResourcesListWidget({Key? key}) : super(key: key);

  @override
  _ResourcesListWidgetState createState() => _ResourcesListWidgetState();
}
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            ...
            context.pushNamed('resourcesList');
          },
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          'Learn your symptoms with the resources that curated by professional',
                ...
                StreamBuilder<List<ResourcesRecord>>(
                  stream: queryResourcesRecord(
                    queryBuilder: (resourcesRecord) =>
                        resourcesRecord.orderBy('resourceName'),
                  ),
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                'resourceDetails',
                                queryParameters: {
                                  'resourceNote': serializeParam(
                                    listViewResourcesRecord.reference,
